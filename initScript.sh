...
geth --datadir ~/geth-git/test-chain-dir console --http.api="db,eth,net,web3,personal,web3" --allow-insecure-unlock --http --miner.gaslimit '20000000' --unlock 0x0766fd8a11485bb8c045919ac5a07c51b3d1696b --mine
